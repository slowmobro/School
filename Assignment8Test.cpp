...
double highestGravity(const fluidType fList[], int listSize)
{
    ...
    //For loop iterates through each fluid's specific gravity, keeping the highest
...
void print(const fluidType fList[], int listSize)
{
    ...
    outFile << endl
            << "Highest Specific Gravity: " << maxGrav << endl;
    outFile << "Fluid having the highest Specific Gravity:" << endl;
